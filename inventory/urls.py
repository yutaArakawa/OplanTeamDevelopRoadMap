...
urlpatterns = [
    ...
    path('order/goods/', OrderGoodsListView.as_view(), name='order_goods_list'),
    path('order/goods/download/csv/', OrderCsvDownloadView.as_view(), name='order_csv_download'),
    path('order/goods/import/csv/', OrderCsvImportView.as_view(), name='order_csv_import'),
    path('order/create/<int:goods_pk>/', OrderCreateView.as_view(), name='order_create'),
    path('order/history/', OrderHistoryView.as_view(), name='order_history'),
    path('order/history/export/csv/', OrderHistoryCSVExportView.as_view(), name='order_history_csv_export'),
    path('order/history/export/pdf/', OrderHistoryPDFExportView.as_view(), name='order_history_pdf_export'),
]
